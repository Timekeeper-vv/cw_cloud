...
// 信号测试路由
const signalTestRouter: AppRouteRecordRaw = {
  path: '/test',
  component: Layout,
  name: 'Test',
  meta: {
  ...
  children: [
    {
      path: 'signal',
      name: 'SignalTest',
      component: () => import('@/views/test/SignalTest.vue'),
      meta: {
        title: '信号测试',
        icon: 'ep:pie-chart'
      }
    },
    {
      path: 'real-signal',
      name: 'RealSignalTest',
      component: () => import('@/views/test/RealSignal.vue'),
      meta: {
        title: '真实信号显示',
        icon: 'ep:data-line'
      }
...
remainingRouter.push(signalTestRouter)
